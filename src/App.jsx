  ...
  projects: [
    {
      ...
      details:
        'A cleaner case-study card for a public-facing airphoto access experience. This React portfolio keeps the project as an outbound link while making the portfolio itself independent from ArcGIS hosting.',
      stack: ['ArcGIS Experience Builder', 'Dashboard UX', 'Airphotos', 'Search design'],
      links: [
        { label: 'Live project', href: 'https://experience.arcgis.com/experience/b6571e82a3c74d8e9554abcc3acbd30f/' },
      ],
    },
    {
      ...
      details:
        'This portfolio version presents the project as a polished card with technical context instead of nesting the entire portfolio inside StoryMaps again.',
      stack: ['StoryMaps', 'Campus mapping', 'Cartography', 'Visual storytelling'],
      links: [
        { label: 'View story', href: 'https://storymaps.arcgis.com/stories/948c9bc00fbd4b41b1b201fd2124a4f9' },
      ],
    },
    {
      ...
      details:
        'Strong portfolio piece for showing data distribution, metadata access, and spatial data delivery workflows.',
      stack: ['ArcGIS Hub', 'Open data', 'Metadata', 'Data delivery'],
      links: [
        { label: 'Open portal', href: 'https://university-of-waterloo-geospatial-centre-open-data-geouw.hub.arcgis.com/' },
      ],
    },
    {
      title: 'Crime Analysis of Waterloo Region',
      category: 'GIS & Analytics',
      featured: true,
      preview: 'https://picsum.photos/seed/geoport-crime/800/450',
      summary:
        'Spatial and temporal crime analysis using ArcPy with automated workflows and mapped trends.',
      details:
        'Positioned here as an applied GIS analysis case study focused on workflow automation, spatial insight, and decision support.',
      stack: ['ArcPy', 'Spatial analysis', 'Automation', 'Python'],
      links: [
        { label: 'GitHub repo', href: 'https://github.com/GP254/Crime-Analysis-of-Waterloo-Region-ArcPy/tree/main' },
      ],
    },
    {
      title: 'Canadian Nursing Workforce and Facility Analysis',
      category: 'Data Science',
      featured: false,
      preview: 'https://picsum.photos/seed/geoport-nursing/800/450',
      summary:
        'Notebook-based spatial and data analysis project examining nursing workforce and facility patterns.',
      details:
        'This slot is set up to let you expand the project into a proper portfolio case study later, with methods, data sources, and key findings.',
      stack: ['Python', 'Jupyter', 'Data analysis', 'Spatial insight'],
      links: [
        {
          label: 'Notebook',
          href: 'https://github.com/GP254/Canadian-Nursing-Workforce-and-Facility-Analysis/blob/main/Canadian-Nursing-Workforce-and-Facility-Analysis.ipynb',
        },
      ],
    },
    {
      ...
      category: 'Data Science',
      featured: false,
      preview: 'https://picsum.photos/seed/geoport-student/800/450',
      summary:
        'Exploratory data analysis of student test performance influenced by multiple factors.',
      details:
        'Useful supporting project for showing statistical reasoning, data cleaning, visualization, and model interpretation beyond GIS-only work.',
      stack: ['Python', 'EDA', 'Visualization', 'Jupyter'],
      links: [
        {
          label: 'Notebook',
          href: 'https://github.com/GP254/Student-Performance-Data-Analysis/blob/main/Student%20Performance%20Data%20Analysis.ipynb',
        },
      ],
    },
    {
      title: 'Global Life Expectancy Webmap',
      category: 'Web Mapping',
      featured: false,
      preview: 'https://picsum.photos/seed/geoport-life/800/450',
      summary:
        'Interactive webmap with hover effects exported from QGIS to the web.',
      details:
        'Included from the current portfolio as a strong example of lightweight public-facing web cartography.',
      stack: ['QGIS', 'qgis2web', 'Web cartography'],
      links: [{ label: 'Open webmap', href: 'https://qgislifeexpectancywebmap.netlify.app/' }],
    },
    {
      title: 'Layer Visibility Webmap',
      category: 'Web Mapping',
      featured: false,
      preview: 'https://picsum.photos/seed/geoport-layers/800/450',
      summary:
        'Webmap demonstrating scale-dependent layer visibility from region level to neighbourhood and street level.',
      details:
        'Useful portfolio example for showing map scale logic, layered presentation, and web cartographic control.',
      stack: ['Web mapping', 'Scale visibility', 'Cartography'],
      links: [{ label: 'Open webmap', href: 'https://brilliant-toffee-720331.netlify.app/' }],
    },
    {
      title: 'Digital Map Gallery',
      category: 'Cartography',
      featured: false,
      preview: 'https://picsum.photos/seed/geoport-gallery/800/450',
      summary:
        'Static cartographic work including terrain, choropleth, dot density, proportional symbol, posters, and guide maps.',
      details:
        'The React build gives this section a more professional gallery treatment and a clearer separation from interactive projects.',
      stack: ['Cartography', 'Print mapping', 'Visual hierarchy'],
      links: [],
    },
  ],
}
          ...
          <div className="container split-layout">
            <div className="about-column">
              ...
              <div className="about-preview-wrap">
                <img
                  ...
                  src={portfolio.profile.aboutImage}
                  alt=""
                  loading="lazy"
                  decoding="async"
                />
            ...
            <div className="content-stack">
              <p>
                ...
                webmaps. This React implementation preserves that taxonomy while converting the experience into a standard
                web application deployable on GitHub Pages, Netlify, or Vercel without a university ArcGIS dependency
                for core site hosting.
              </p>
              <p>
            ...
            <div className="projects-layout">
              <div className="project-grid">
                {filteredProjects.map((project) => (
                  <article
                    key={project.title}
                    className={`project-card card ${selectedProject.title === project.title ? 'project-card-active' : ''}`}
                ...
                <div className="project-spotlight-inner">
                  ...
                  <div className="spotlight-actions">
                    {selectedProject.links.map((link) => (
                      <a className="button button-primary" key={link.href} href={link.href} target="_blank" rel="noreferrer">
                        {link.label}
                      </a>
                    ))}
